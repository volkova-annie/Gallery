class Value < ApplicationRecord
  ...
  def self.calc_average_value(image_id)
    ...
    return ave_value.round
    logger.info "In value.rb > calc_average_value: values_arr = #{values_arr.inspect}, values_sum = #{values_sum.inspect}, ave_value = #{ave_value.inspect}"
  end
